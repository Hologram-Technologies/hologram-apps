...
export class Aarch64Workspace {
     ...
     * @returns {Aarch64Workspace}
     */
    static boot_devcontainer_opfs_streamed_graphical(kernel, rootfs_handle, disk_handle) {
        const ptr0 = passArray8ToWasm0(kernel, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.aarch64workspace_boot_devcontainer_opfs_streamed_graphical(ptr0, len0, rootfs_handle, disk_handle);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return Aarch64Workspace.__wrap(ret[0]);
    ...
    fb_write(bytes) {
        ...
        const len0 = WASM_VECTOR_LEN;
        wasm.aarch64workspace_fb_write(this.__wbg_ptr, ptr0, len0);
    }
    /**
     ...
     */
    framebuffer() {
        const ret = wasm.aarch64workspace_framebuffer(this.__wbg_ptr);
     ...
     */
    framebuffer_base() {
        const ret = wasm.aarch64workspace_framebuffer_base(this.__wbg_ptr);
        return ret;
    }
    /**
     ...
     */
    framebuffer_dims() {
        const ret = wasm.aarch64workspace_framebuffer_dims(this.__wbg_ptr);
     ...
     * @returns {Aarch64Workspace}
     */
    static new_fb_harness(ram_mb) {
        const ret = wasm.aarch64workspace_new_fb_harness(ram_mb);
...
export class DevcontainerImage {
     ...
     * @returns {number}
     */
    assembleBootableWithInitIntoOpfs(rootfs_handle, disk_bytes, init) {
        const ptr0 = passArray8ToWasm0(init, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.devcontainerimage_assembleBootableWithInitIntoOpfs(this.__wbg_ptr, rootfs_handle, disk_bytes, ptr0, len0);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return ret[0];
...
export class X64Workspace {
    ...
    static boot_devcontainer_opfs_streamed_graphical(kernel, rootfs_handle, disk_handle) {
        const ptr0 = passArray8ToWasm0(kernel, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.x64workspace_boot_devcontainer_opfs_streamed_graphical(ptr0, len0, rootfs_handle, disk_handle);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return X64Workspace.__wrap(ret[0]);
     ...
     * @returns {X64Workspace}
     */
    static boot_linux_initramfs_streamed(kernel, rootfs_handle, disk_handle) {
        const ptr0 = passArray8ToWasm0(kernel, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.x64workspace_boot_linux_initramfs_streamed(ptr0, len0, rootfs_handle, disk_handle);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return X64Workspace.__wrap(ret[0]);
     ...
     */
    enable_loopback() {
        const ret = wasm.x64workspace_enable_loopback(this.__wbg_ptr);
        return ret !== 0;
    }
    /**
    ...
    exc_trace() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.x64workspace_exc_trace(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
    ...
    fb_write(bytes) {
        const ptr0 = passArray8ToWasm0(bytes, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.x64workspace_fb_write(this.__wbg_ptr, ptr0, len0);
    }
    /**
     * Feed keystrokes to the guest's serial console.
     * @param {Uint8Array} bytes
     ...
     * @param {number} evdev_code
     * @param {boolean} down
     */
    feed_key(evdev_code, down) {
        wasm.x64workspace_feed_key(this.__wbg_ptr, evdev_code, down);
    }
    /**
     ...
     * @param {boolean} down
     */
    feed_pointer_button(button, down) {
        wasm.x64workspace_feed_pointer_button(this.__wbg_ptr, button, down);
    }
    /**
     ...
     * @param {number} dy
     */
    feed_pointer_motion(dx, dy) {
        wasm.x64workspace_feed_pointer_motion(this.__wbg_ptr, dx, dy);
    }
    /**
     ...
     */
    feed_wheel(clicks) {
        wasm.x64workspace_feed_wheel(this.__wbg_ptr, clicks);
    }
    /**
     ...
     */
    framebuffer() {
        const ret = wasm.x64workspace_framebuffer(this.__wbg_ptr);
        var v1 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
        wasm.__wbindgen_free(ret[0], ret[1] * 1, 1);
        return v1;
    }
     ...
     */
    framebuffer_base() {
        const ret = wasm.x64workspace_framebuffer_base(this.__wbg_ptr);
        return ret;
    }
    /**
     ...
     */
    framebuffer_dims() {
        const ret = wasm.x64workspace_framebuffer_dims(this.__wbg_ptr);
        var v1 = getArrayU32FromWasm0(ret[0], ret[1]).slice();
        wasm.__wbindgen_free(ret[0], ret[1] * 4, 4);
        return v1;
    }
    ...
    halt_reason() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.x64workspace_halt_reason(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
    ...
    region_divergence() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.x64workspace_region_divergence(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
     ...
     * @returns {X64Workspace}
     */
    static resume(snapshot) {
        const ptr0 = passArray8ToWasm0(snapshot, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.x64workspace_resume(ptr0, len0);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return X64Workspace.__wrap(ret[0]);
     ...
     * @param {Uint8Array} pages_bin
     * @param {string} pages_idx
     * @param {Uint8Array} disk_image
     * @param {Uint8Array} delta_bin
     * @param {string} delta_idx
     * @returns {X64Workspace}
     */
    static resume_desktop_from_layer(manifest, pages_bin, pages_idx, disk_image, delta_bin, delta_idx) {
        const ptr0 = passArray8ToWasm0(manifest, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passArray8ToWasm0(pages_bin, wasm.__wbindgen_malloc);
        const len1 = WASM_VECTOR_LEN;
        const ptr2 = passStringToWasm0(pages_idx, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len2 = WASM_VECTOR_LEN;
        const ptr3 = passArray8ToWasm0(disk_image, wasm.__wbindgen_malloc);
        const len3 = WASM_VECTOR_LEN;
        const ptr4 = passArray8ToWasm0(delta_bin, wasm.__wbindgen_malloc);
        const len4 = WASM_VECTOR_LEN;
        const ptr5 = passStringToWasm0(delta_idx, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len5 = WASM_VECTOR_LEN;
        const ret = wasm.x64workspace_resume_desktop_from_layer(ptr0, len0, ptr1, len1, ptr2, len2, ptr3, len3, ptr4, len4, ptr5, len5);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return X64Workspace.__wrap(ret[0]);
     ...
     * @returns {X64Workspace}
     */
    static resume_kappa(blob) {
        const ptr0 = passArray8ToWasm0(blob, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.x64workspace_resume_kappa(ptr0, len0);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return X64Workspace.__wrap(ret[0]);
    ...
    /**
     * **Pack resume** — the object fabric's compact form (`CC-81 M4`) consumed IN THE TAB: the
     * deflate-compressed manifest + ONE shared deflate packfile + its text index
     * (`<hexκ> <off> <len>` per line), exactly what `holo run` publishes under `HOLO_KAPPA_OBJ=1`.
     * Everything stays inside wasm (the fetch callbacks the streaming restore needs are
     * synchronous, which rules out JS-side `DecompressionStream`): the manifest inflates here,
     * each κ-object inflates from the resident pack on demand — RAM pages during the restore,
     * disk sectors LAZILY on first guest read — and every object is **verified against its κ
     * before use** (L5), so a tampered pack entry is refused. The pack moves into the machine's
     * disk closure and stays resident for its lifetime; the tab never materializes the flat
     * `.holo` (for nginx: fetch ~59 MiB manifest+pack instead of a 152 MiB blob, and the pack is
     * SHARED across images — a second alpine app re-fetches almost nothing).
     * @param {Uint8Array} manifest_z
     * @param {string} idx_text
     * @param {Uint8Array} pack
     * @returns {X64Workspace}
     */
    static resume_kappa_pack(manifest_z, idx_text, pack) {
        const ptr0 = passArray8ToWasm0(manifest_z, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(idx_text, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        const ptr2 = passArray8ToWasm0(pack, wasm.__wbindgen_malloc);
        const len2 = WASM_VECTOR_LEN;
        const ret = wasm.x64workspace_resume_kappa_pack(ptr0, len0, ptr1, len1, ptr2, len2);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return X64Workspace.__wrap(ret[0]);
    ...
    /**
     * **Lazy pack resume** — as [`resume_kappa_pack`](X64Workspace::resume_kappa_pack) but the tab
     * fetches ONLY the RAM working set up front, never the whole packfile. `manifest` is the
     * already-inflated manifest (the page needed it for [`kappa_manifest_pages`] to plan its
     * coalesced Range prefetch); `ram_objs` maps each RAM κ's 64-hex name to its still-deflated
     * pack entry; disk objects are pulled ON FAULT through `disk_fetch` — a **synchronous** JS
     * callback (sync XHR Range in a worker) taking the 64-hex name and returning the deflated
     * entry (`Uint8Array`) or `null`. Bytes before live ≈ manifest + RAM objects; a disk sector
     * crosses the wire only when the guest actually reads it. Every object is inflated here and
     * **verified against its κ before use** (L5), so a tampered Range response is refused.
     * @param {Uint8Array} manifest
     * @param {Map<any, any>} ram_objs
     * @param {Function} disk_fetch
     * @returns {X64Workspace}
     */
    static resume_kappa_pack_lazy(manifest, ram_objs, disk_fetch) {
        const ptr0 = passArray8ToWasm0(manifest, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.x64workspace_resume_kappa_pack_lazy(ptr0, len0, ram_objs, disk_fetch);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return X64Workspace.__wrap(ret[0]);
    ...
    /**
     * **Fully-lazy pack resume** (`CC-82` increment 3) — nothing but the manifest moves up front.
     * RAM pages are FAULT-LAZY: each non-zero page materializes on its first touch (execution,
     * DMA, anything) through `fetch`, and disk sectors stream the same way through the same
     * callback — so bytes-before-live ≈ the manifest alone, and the machine then pulls only the
     * κ-objects it actually runs. `fetch` is a **synchronous** JS callback (sync XHR Range /
     * OPFS read in a worker) taking the 64-hex κ name and returning the still-deflated pack
     * entry (`Uint8Array`) or `null`. Every object is inflated here and **verified against its κ
     * before use** (L5); a page that cannot be fetched or verified traps the machine fail-closed.
     * @param {Uint8Array} manifest
     * @param {Function} fetch
     * @returns {X64Workspace}
     */
    static resume_kappa_pack_lazy_ram(manifest, fetch) {
        const ptr0 = passArray8ToWasm0(manifest, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.x64workspace_resume_kappa_pack_lazy_ram(ptr0, len0, fetch);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return X64Workspace.__wrap(ret[0]);
     ...
     * @returns {X64Workspace}
     */
    static resume_kappa_streamed(manifest, fetch) {
        const ptr0 = passArray8ToWasm0(manifest, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.x64workspace_resume_kappa_streamed(ptr0, len0, fetch);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return X64Workspace.__wrap(ret[0]);
     ...
     * @returns {Uint8Array | undefined}
     */
    serve_kappa_page(kappa) {
        const ptr0 = passStringToWasm0(kappa, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.x64workspace_serve_kappa_page(this.__wbg_ptr, ptr0, len0);
        let v2;
        if (ret[0] !== 0) {
            v2 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
            wasm.__wbindgen_free(ret[0], ret[1] * 1, 1);
     ...
     * @param {boolean} on
     * @param {boolean} notrust
     */
    set_region_jit(on, notrust) {
        wasm.x64workspace_set_region_jit(this.__wbg_ptr, on, notrust);
    }
    /**
     ...
     */
    suspend() {
        const ret = wasm.x64workspace_suspend(this.__wbg_ptr);
        var v1 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
        wasm.__wbindgen_free(ret[0], ret[1] * 1, 1);
        return v1;
    }
     ...
     */
    suspend_kappa() {
        const ret = wasm.x64workspace_suspend_kappa(this.__wbg_ptr);
        var v1 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
        wasm.__wbindgen_free(ret[0], ret[1] * 1, 1);
        return v1;
    }
     ...
     * @returns {Uint8Array}
     */
    suspend_kappa_sealed() {
        const ret = wasm.x64workspace_suspend_kappa_sealed(this.__wbg_ptr);
        if (ret[3]) {
            throw takeFromExternrefTable0(ret[2]);
        }
        var v1 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
 ...
 * @returns {string[]}
 */
export function kappa_manifest_pages(manifest) {
    const ptr0 = passArray8ToWasm0(manifest, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.kappa_manifest_pages(ptr0, len0);
    if (ret[3]) {
        throw takeFromExternrefTable0(ret[2]);
    }
...
function __wbg_get_imports() {
    const import0 = {
        ...
        __wbindgen_cast_0000000000000001: function(arg0, arg1) {
            ...
            const ret = makeMutClosure(arg0, arg1, wasm_bindgen__convert__closures_____invoke__h04ed31e1d1da1b0f);
            return ret;
        },
        ...
        __wbindgen_cast_0000000000000003: function(arg0, arg1) {
            ...
            const ret = makeMutClosure(arg0, arg1, wasm_bindgen__convert__closures_____invoke__h04ed31e1d1da1b0f_2);
            return ret;
        },
        __wbindgen_cast_0000000000000004: function(arg0, arg1) {
            ...
            const ret = makeMutClosure(arg0, arg1, wasm_bindgen__convert__closures_____invoke__h04ed31e1d1da1b0f_3);
            return ret;
        },
        __wbindgen_cast_0000000000000005: function(arg0, arg1) {
            ...
            const ret = makeMutClosure(arg0, arg1, wasm_bindgen__convert__closures_____invoke__h04ed31e1d1da1b0f_4);
            return ret;
        },
...
function wasm_bindgen__convert__closures_____invoke__h04ed31e1d1da1b0f(arg0, arg1, arg2) {
    wasm.wasm_bindgen__convert__closures_____invoke__h04ed31e1d1da1b0f(arg0, arg1, arg2);
}

function wasm_bindgen__convert__closures_____invoke__h04ed31e1d1da1b0f_2(arg0, arg1, arg2) {
    wasm.wasm_bindgen__convert__closures_____invoke__h04ed31e1d1da1b0f_2(arg0, arg1, arg2);
}

function wasm_bindgen__convert__closures_____invoke__h04ed31e1d1da1b0f_3(arg0, arg1, arg2) {
    wasm.wasm_bindgen__convert__closures_____invoke__h04ed31e1d1da1b0f_3(arg0, arg1, arg2);
}

function wasm_bindgen__convert__closures_____invoke__h04ed31e1d1da1b0f_4(arg0, arg1, arg2) {
    wasm.wasm_bindgen__convert__closures_____invoke__h04ed31e1d1da1b0f_4(arg0, arg1, arg2);
}
